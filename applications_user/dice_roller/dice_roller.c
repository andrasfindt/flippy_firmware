...
static void render_callback(Canvas* const canvas, void* ctx) {
    ...
    canvas_draw_frame(
        canvas, center_x - area_size / 2 - 1, center_y - area_size / 2 - 1, area_size, area_size);

    switch(dice_state->last_output) {
    case 1:
        // Center dot
        canvas_draw_disc(
            canvas,
            center_x - DICE_DOT_RADIUS / 2,
            center_y - DICE_DOT_RADIUS / 2,
            DICE_DOT_RADIUS);
        break;
    case 2:
        // Top-left dot
        canvas_draw_disc(
            canvas, left - DICE_DOT_RADIUS / 2, top - DICE_DOT_RADIUS / 2, DICE_DOT_RADIUS);
        // Bottom-right
        canvas_draw_disc(
            canvas, right - DICE_DOT_RADIUS / 2, bottom - DICE_DOT_RADIUS / 2, DICE_DOT_RADIUS);
        break;
    case 3:
        // Top-left dot
        canvas_draw_disc(
    ...
    case 4:
        ...
        // Top-right dot
        canvas_draw_disc(
            canvas, right - DICE_DOT_RADIUS / 2, top - DICE_DOT_RADIUS / 2, DICE_DOT_RADIUS);
        // Bottom-left
        canvas_draw_disc(
            canvas, left - DICE_DOT_RADIUS / 2, bottom - DICE_DOT_RADIUS / 2, DICE_DOT_RADIUS);
        // Bottom-right
        canvas_draw_disc(
            canvas, right - DICE_DOT_RADIUS / 2, bottom - DICE_DOT_RADIUS / 2, DICE_DOT_RADIUS);
        break;
    ...
    case 6:
        ...
        canvas_draw_disc(
            canvas,
            left - DICE_DOT_RADIUS / 2,
            bottom - DICE_DOT_SPACE - DICE_DOT_RADIUS / 2 - DICE_DOT_RADIUS,
            DICE_DOT_RADIUS);
        // Middle-right dot
        canvas_draw_disc(
            canvas,
            right - DICE_DOT_RADIUS / 2,
            bottom - DICE_DOT_SPACE - DICE_DOT_RADIUS / 2 - DICE_DOT_RADIUS,
            DICE_DOT_RADIUS);
        // Bottom-left
        canvas_draw_disc(
    ...
    canvas_draw_str_aligned(
        ...
        AlignRight,
        AlignBottom,
        itoa(dice_state->last_output, str, 10));
    ...
    for(bool processing = true; processing;) {
        ...
        if(event_status == FuriStatusOk) {
            if(evt.input.type == InputTypePress) {
                ...
                case InputKeyOk: {
                    dice_state->last_output =
                        generate_random_number(MIN_DICE_VALUE, MAX_DICE_VALUE + 1);
